...
const heroStats = [
  ...
  { value: "92%", label: "Match de perfil" },
      ...
      <div className="container mx-auto flex h-14 items-center justify-between gap-3 px-4 sm:h-16 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Sheet open={menuOpen} onOpenChange={setMenuOpen}>
            ...
            <SheetContent
              side="right"
              className="w-[min(100vw-2rem,20rem)] border-border"
            >
              <SheetHeader>
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background">
      ...
      <section className="relative flex min-h-[90vh] items-center overflow-hidden">
        ...
        {/* Mobile: full cover so text is always readable */}
        <div className="absolute inset-0 bg-background/90 lg:hidden" />
        {/* Desktop: gradient — fully opaque left, fades to transparent on the right */}
        <div className="absolute inset-0 hidden bg-gradient-to-r from-background via-background/85 to-background/10 lg:block" />
        {/* Bottom fade to avoid harsh edge with next section */}
        <div className="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-background to-transparent" />

        {/* Content */}
        <div className="container relative mx-auto px-4 py-20 sm:px-6 sm:py-24 lg:py-28">
          <div className="w-full max-w-xl lg:max-w-2xl">
            {/* Eyebrow */}
            <div className="landing-eyebrow mb-5 inline-flex">
              <Sparkles className="h-3.5 w-3.5" />
              Puente empresa ↔ talento joven
            </div>

            {/* Headline */}
            <h1 className="text-balance font-display text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl lg:text-[3.5rem] xl:text-6xl">
              De &ldquo;necesito una web&rdquo; a{" "}
              <span className="text-gradient">
                proyecto publicado con IA
              </span>
            </h1>

            {/* Description */}
            <p className="mt-5 max-w-lg text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
              Las PYMEs describen su necesidad en lenguaje cotidiano. La IA la
              convierte en requerimiento técnico. Los jóvenes postulan,
              entregan y construyen{" "}
              <strong className="font-semibold text-foreground">
                portafolio real + perfil QR
              </strong>
              .
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-12 w-full border-border bg-card/80 px-8 text-base backdrop-blur-sm sm:w-auto"
              >
      ...
      <section
        id="problem"
        className="scroll-mt-14 py-16 sm:scroll-mt-16 sm:py-24"
      >
        <div className="container mx-auto px-4 sm:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              No es otro marketplace genérico: conectamos la necesidad real del
              empresario con la energía del talento que empieza.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <article className="landing-path-card">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Tiene skills, le falta el caso real que abra la primera
                entrevista.
              </p>
            ...
            <article className="landing-path-card">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Sabe su negocio, no sabe pedir un proyecto digital ni pagar una
                agencia.
              </p>
              <ul className="mt-5 space-y-3">
                {[
      ...
      <section
        id="features"
        className="scroll-mt-14 bg-muted/40 py-16 sm:scroll-mt-16 sm:py-24"
      >
        <div className="container mx-auto px-4 sm:px-6">
          <div className="mx-auto max-w-2xl text-center">
            <p className="landing-section-label">Plataforma</p>
            <h2 className="section-heading mt-3">
              Herramientas que venden el pitch
            </h2>
            <p className="mt-4 text-muted-foreground">
              Cada función resuelve un punto del flujo empresa → IA → talento →
              entrega.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              <article
                key={title}
                className="card-paper flex flex-col p-6 sm:p-8"
              >
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="landing-testimonial mx-auto max-w-3xl p-8 sm:p-10">
            ...
            <blockquote className="relative mt-6 text-center font-display text-xl font-medium leading-snug sm:text-2xl">
              Publicamos lo que necesitábamos sin saber de tecnología. En dos
              semanas teníamos la web y un estudiante con un caso real en su
              portafolio.
            </blockquote>
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <div className="logo-mark h-11 w-11 rounded-full text-sm font-bold">
                PS
              </div>
              <div className="text-center sm:text-left">
                <p className="font-semibold">Panadería El Sol</p>
                <p className="text-sm text-muted-foreground">
                  Cliente demo · WorkConnect seed
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto mt-10 grid max-w-4xl gap-6 md:grid-cols-2">
            <article className="landing-path-card flex flex-col">
              ...
              <p className="mt-2 flex-1 text-sm text-muted-foreground">
                Explora micro-proyectos, postula con IA y construye tu
            ...
            <article className="landing-path-card flex flex-col">
              ...
              <p className="mt-2 flex-1 text-sm text-muted-foreground">
                Publica tu necesidad, deja que la IA arme el requerimiento y
          ...
          <div className="landing-cta-final relative overflow-hidden px-6 py-12 text-center sm:px-12 sm:py-16">
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-3 max-w-lg text-primary-foreground/85">
                Únete a WorkConnect y convierte necesidades locales en

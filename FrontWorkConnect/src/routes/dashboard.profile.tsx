...
<html lang="es"><head><meta charset="utf-8" /><title>Certificado - ${r.skill_name}</title>
<style>
...
<div class="frame">
  ...
  <p class="score">Puntuación: <strong>${r.score}%</strong> · ${r.correct_count}/${r.total} respuestas correctas</p>
